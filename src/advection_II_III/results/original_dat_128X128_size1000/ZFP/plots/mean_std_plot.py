...
def main():
    ...
    for i in range(trials):
        ...
        with open(f"../eb0.1/trail_{i}/y_error_deeponet_case1.dat") as file:
            metrics_case1.append(np.loadtxt(file))

        with open(f"../eb0.01/trail_{i}/y_error_deeponet_case1.dat") as file:
            metrics_case2.append(np.loadtxt(file))

        with open(f"../eb0.001/trail_{i}/y_error_deeponet_case1.dat") as file:
            metrics_case3.append(np.loadtxt(file))

        with open(f"../eb0.0001/trail_{i}/y_error_deeponet_case1.dat") as file:
            metrics_case4.append(np.loadtxt(file))

        with open(f"../eb0.1/trail_{i}/y_error_deeponet_case2.dat") as file:
            metrics_case1_2.append(np.loadtxt(file))

        with open(f"../eb0.01/trail_{i}/y_error_deeponet_case2.dat") as file:
            metrics_case2_2.append(np.loadtxt(file))

        with open(f"../eb0.001/trail_{i}/y_error_deeponet_case2.dat") as file:
            metrics_case3_2.append(np.loadtxt(file))

        with open(f"../eb0.0001/trail_{i}/y_error_deeponet_case2.dat") as file:
        ...
        with open(f"../eb0.1/trail_{i}/y_error_deeponet_case4.dat") as file:
            metrics_case1_4.append(np.loadtxt(file))

        with open(f"../eb0.01/trail_{i}/y_error_deeponet_case4.dat") as file:
            metrics_case2_4.append(np.loadtxt(file))

        with open(f"../eb0.001/trail_{i}/y_error_deeponet_case4.dat") as file:
            metrics_case3_4.append(np.loadtxt(file))

        with open(f"../eb0.0001/trail_{i}/y_error_deeponet_case4.dat") as file:
            metrics_case4_4.append(np.loadtxt(file))

        with open(f"../eb0.1/trail_{i}/y_error_deeponet_case5.dat") as file:
            metrics_case1_5.append(np.loadtxt(file))

        with open(f"../eb0.01/trail_{i}/y_error_deeponet_case5.dat") as file:
            metrics_case2_5.append(np.loadtxt(file))

        with open(f"../eb0.001/trail_{i}/y_error_deeponet_case5.dat") as file:
            metrics_case3_5.append(np.loadtxt(file))

        with open(f"../eb0.0001/trail_{i}/y_error_deeponet_case5.dat") as file:
...
def plot_error_bar(l2_means, l2_stddevs, linf_means, linf_stddevs):
    cases = [
        "Clean",
        r"all $0.1\sigma$ train",
        r"all $0.01\sigma$ train",
        r"all $0.001\sigma$ train",
        r"all $0.0001\sigma$ train",
        r"all $0.1\sigma$ test",
        r"all $0.01\sigma$ test",
        r"all $0.001\sigma$ test",
        r"all $0.0001\sigma$ test",
        r"all $0.1\sigma$ both",
        r"all $0.01\sigma$ both",
        r"all $0.001\sigma$ both",
        r"all $0.0001\sigma$ both",
        r"half $0.1\sigma$ train",
        r"half $0.01\sigma$ train",
        r"half $0.001\sigma$ train",
        r"half $0.0001\sigma$ train",
    ]
