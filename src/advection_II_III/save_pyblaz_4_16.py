...
codec = PyBlaz(block_shape=(4, 4), dtype=torch.float32, index_dtype=torch.int16, device=device)
...
decompressed_x_train_0.tofile(
    "../../original_dat_128X128_size1000/pyBlaz/blocksize_4_index_16/decompressed_dat/x_train_0.dat"
)
decompressed_x_train_1.tofile(
    "../../original_dat_128X128_size1000/pyBlaz/blocksize_4_index_16/decompressed_dat/x_train_1.dat"
)
decompressed_x_test_0.tofile(
    "../../original_dat_128X128_size1000/pyBlaz/blocksize_4_index_16/decompressed_dat/x_test_0.dat"
)
decompressed_x_test_1.tofile(
    "../../original_dat_128X128_size1000/pyBlaz/blocksize_4_index_16/decompressed_dat/x_test_1.dat"
)
decompressed_y_train.tofile(
    "../../original_dat_128X128_size1000/pyBlaz/blocksize_4_index_16/decompressed_dat/y_train.dat"
)
decompressed_y_test.tofile(
    "../../original_dat_128X128_size1000/pyBlaz/blocksize_4_index_16/decompressed_dat/y_test.dat"
)
